...
import { UsersIcon, UserPlus, Plus, CalendarPlus, FileText } from 'lucide-react';
  ...
  const statistics: Statistic[] = [
    {
      ...
      label: 'Total Teams',
      value: 12,
      icon: <Image src={teamIcon} alt="Team Icon" width={40} height={40} />,
    ...
    },
    {
      ...
      label: 'Total Players',
      value: 240,
      icon: <Image src={playerIcon} alt="Player Icon" width={40} height={40} />,
      color: 'text-blue-500',
    },
    {
      id: '3',
    ...
    },
    {
      ...
      label: 'Total Goals',
      value: 156,
      icon: <Image src={goalIcon} alt="Goal Icon" width={40} height={40} />,
  ...
  return (
    <div className="space-y-16 p-4 lg:p-10">
      ...
      <div>
        ...
        <p className="mt-2 text-muted-foreground">Overview of your tournament management</p>
      </div>
