    ...
    <div className="space-y-6 p-4 lg:p-6 max-w-4xl mx-auto">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Fill in the details below to create a new team</CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <FieldContent>
                  ...
                  <FieldDescription>{/* The official name of the team */}</FieldDescription>
                </FieldContent>
              </Field>
            </FieldGroup>
          </CardContent>
          ...
          <CardFooter className="flex flex-col sm:flex-row gap-3 sm:justify-end">
            ...
            <Button type="submit" disabled={adminCreateTeamLoading} className="w-full sm:w-auto cursor-pointer">
              {adminCreateTeamLoading ? 'Creating...' : 'Create Team'}
            </Button>
          </CardFooter>
        </form>
      </Card>
