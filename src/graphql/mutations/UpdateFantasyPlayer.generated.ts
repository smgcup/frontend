...
export type UpdateFantasyPlayerMutation = { __typename?: 'Mutation', updateFantasyPlayer: { __typename?: 'FantasyPlayer', playerId: string, displayName?: string | null, price: number } };
