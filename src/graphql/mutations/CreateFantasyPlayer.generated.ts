...
export type CreateFantasyPlayerMutation = { __typename?: 'Mutation', createFantasyPlayer: { __typename?: 'FantasyPlayer', playerId: string, displayName?: string | null, price: number } };
