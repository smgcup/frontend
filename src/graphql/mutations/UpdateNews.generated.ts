...
export type UpdateNewsMutation = { __typename?: 'Mutation', updateNews: { __typename?: 'News', id: string, title: string, content: string, createdAt: string, category: string, imageUrl: string } };
