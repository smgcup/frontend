...
export const UpdateMatchDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateMatch' },
      variableDefinitions: [
        {
        ...
        },
        {
          ...
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateMatchDto' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            arguments: [
              ...
              { kind: 'Argument', name: { kind: 'Name', value: 'updateMatchDto' }, value: { kind: 'Variable', name: { kind: 'Name', value: 'dto' } } },
            ],
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
...
} as unknown as DocumentNode<UpdateMatchMutation, UpdateMatchMutationVariables>;
