...
export type GetNewsQuery = { __typename?: 'Query', news: Array<{ __typename?: 'News', category: string, content: string, createdAt: any, id: string, imageUrl: string, title: string }> };
