...
export type GetFantasyPlayersQuery = { __typename?: 'Query', fantasyPlayers: Array<{ __typename?: 'FantasyPlayer', playerId: string, displayName?: string | null, price: number }> };
