...
export type GetTopPlayersQuery = { __typename?: 'Query', topPlayers: Array<{ __typename?: 'Player', id: string, lastName: string, firstName: string, team: { __typename?: 'Team', id: string, name: string }, stats: { __typename?: 'Stats', goals: number, assists: number } }> };
