...
export type GetMatchesQuery = { __typename?: 'Query', matches: Array<{ __typename?: 'Match', id: string, date: string, status: Types.MatchStatus, score1?: number | null, score2?: number | null, firstOpponent: { __typename?: 'Team', id: string, name: string }, secondOpponent: { __typename?: 'Team', id: string, name: string } }> };
