...
export type GetNewsByIdQuery = { __typename?: 'Query', newsById: { __typename?: 'News', category: string, content: string, createdAt: string, id: string, imageUrl: string, title: string } };
