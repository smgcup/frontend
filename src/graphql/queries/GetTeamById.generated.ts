...
export type TeamByIdQuery = { __typename?: 'Query', teamById: { __typename?: 'Team', id: string, name: string, createdAt: string, players: Array<{ __typename?: 'Player', age: number, id: string, firstName: string, lastName: string }> } };
