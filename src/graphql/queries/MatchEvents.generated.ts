...
export type MatchEventsQuery = { __typename?: 'Query', matchEvents: Array<{ __typename?: 'MatchEvent', id: string, type: Types.MatchEventType, minute: number, createdAt: string, team: { __typename?: 'Team', id: string, name: string }, player?: { __typename?: 'Player', id: string, firstName: string, lastName: string } | null }> };
